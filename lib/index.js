...
cli
  ...
  .option('-e, --use-examples-value', 'Will return a random value from examples or single value from example if present')
...
if (cli.useExamplesValue === true) {
  settings.useExamplesValue = true;
}
